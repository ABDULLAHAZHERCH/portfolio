export const projects = [
    ...
    },
    {
      ...
      description:
        "A modern, web-based presentation tool that uses Google's Gemini AI to generate and design complete slide decks from a single prompt. Features a Canva-like editor for deep customization, AI-powered content and image generation, multiple design styles, rich text editing, dynamic backgrounds, full slide management, undo/redo, and multi-format export (PNG, PDF, PPTX). Responsive design for desktop and mobile.",
      image: "/placeholder.svg?height=300&width=500",
      category: "AI",
      tags: [
        "React",
