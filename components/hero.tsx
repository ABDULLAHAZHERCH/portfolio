      ...
      <div className="section-container grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
            Hi, I'm <span className="text-primary">Abdullah Azher Chaudhary</span>
          </h1>
          <h2 className="text-xl md:text-2xl mb-6 text-muted-foreground">Computer Science Student at UET Lahore</h2>
          <p className="text-lg mb-8 max-w-lg">
            Passionate about AI, development, cybersecurity, and programming. Building innovative solutions to
            real-world problems.
          </p>
        ...
        >
          ...
          <div className="relative h-full w-full overflow-hidden rounded-full border-4 border-primary/20">
            <Image
